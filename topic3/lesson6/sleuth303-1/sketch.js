...
Officer: 4747203
CaseNum: 303-0-78086073-4747203
...
The first safe is in Torvald’s office. Crack it by doing the following:
	...
	- Make SecureLockerValue_0 equal to 14

	When any key is pressed:
	- Make SecureLockerValue_0 equal to 13

	When any key is released:
	- Make SecureLockerValue_0 equal to 12

	Whilst the mouse is moving:
	- Make SecureLockerValue_0 equal to 7

	Whilst the mouse is being dragged:
	- Make SecureLockerValue_1 equal to 47

	When the mouse button is pressed:
	- Make SecureLockerValue_1 equal to 6

	When any key is released:
	- Make SecureLockerValue_1 equal to 54

	When the mouse button is released:
	- Make SecureLockerValue_1 equal to 74
...
var SecureLockerValue_0;
var SecureLockerValue_1;
...
function setup()
{
	...
	SecureLockerValue_0 = 0;
	SecureLockerValue_1 = 0;
...
function draw()
{
	...
	drawDial(200, SecureLockerValue_0, 35);
	pop();

	//Draw the lever
	push();
	translate(width - 125,256);
	drawLever(SecureLockerValue_1);
	pop();
