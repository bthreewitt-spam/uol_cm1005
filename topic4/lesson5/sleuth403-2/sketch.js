...
Officer: 4747203
CaseNum: 403-1-66812807-4747203
...
Whenever Shiffman (signified by the mouse) is within 77 pixels of Norbert's Burrito Stall - draw a OliveDrab ellipse with a radius of 77 around it.
...
function draw()
{
    ...
    if(dist(815, 365, mouseX, mouseY) < 77){
        fill(107,142,35);
        ellipse(815, 365, 154);
    }
